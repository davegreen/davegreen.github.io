---
layout: post
title: An IC no longer
date: 2026-04-22 22:00
author: Dave Green
comments: true
categories: [Books, Leading]
---
...
As well as new things, there's also rediscovery of things I've read or immersed myself in before. A good example of this is [`Turn the Ship Around` by L. David Marquet](https://davidmarquet.com/books/turn-the-ship-around-book/) and intent (Leader/Leader) based interaction. I was reintroduced to it via a reference to the [Radio Free XP podcast](https://open.spotify.com/show/1tYFyqg96xZzJlOZMjpc8P?si=p0sWD_P1Rhqxc-y0TpB9ag) in a podcast from the absolutely excellent writer (and technologist) [Nikhil Suresh](https://ludic.mataroa.blog/). I haven't linked to the specific episode, you should read (and listen to) all his stuff!
